...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <ul>
      <li>Explore your dashboard and get familiar with the tools.</li>
      <li>Customize your profile and settings to suit your needs.</li>
      <li>Reach out to our support team anytime if you need help.</li>
    </ul>
    <p>We're looking forward to helping you make the most of your journey with us.</p>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>You requested to sign in using a magic link. Click the button below to securely access your account:</p>
    <div style="text-align: center; margin: 30px 0;">
